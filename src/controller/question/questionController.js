...
exports.questionListController = async (req, res, next) => {
    try {
...
exports.questionUpdateController = async(req,res,next) =>{
    try {
...
exports.questionDeleteController = async(req,res,next) =>{
    try {
